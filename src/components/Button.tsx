...
export function Button({
  ...
  const base =
    "inline-flex items-center justify-center rounded-lg px-6 py-3 font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ascone-primary focus:ring-offset-2 hover:scale-[1.02] active:scale-[0.98]";
  const primary =
